...
#                        of executable (1/0)?
MODEL                = control
MODULES              = main.c stm32xxxx_it.c
MODULES_OBJ          = main.obj stm32xxxx_it.obj 
MAKEFILE             = control.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = control_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IC:/Users/LICHON~1/project/mpu6050/matlab  -IC:/Users/LICHON~1/project/mpu6050/matlab/control_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert 
